      ...
      >
        ...
        <View>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput placeholder="Enter email address" editable maxLength={10}keyboardType="numeric" onChangeText={text => onChangeText(text)}
        value={value}/>
          </View>
        </View>
        <TouchableOpacity >
        ...
        <Button title="Continue" disabled={value.length===10?false:true}/>
        </View>
